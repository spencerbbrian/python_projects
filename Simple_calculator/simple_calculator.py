...
add_button = Button(root, text="+", padx=39,pady=20, command=button_click)
equal_button = Button(root, text="=", padx=91,pady=20, command=button_click)
clear_button = Button(root, text="clear", padx=79,pady=20, command=button_click)
